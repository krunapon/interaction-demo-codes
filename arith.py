...
# approximation of pi, Python displays 15 decimal digits

print(f"{3.1415926535897932384626433832795028841971}")

# appoximation of square root of two 

print(f"{1.4142135623730950488016887242096980785696}")
